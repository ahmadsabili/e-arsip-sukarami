@extends('layouts.main', ['title' => 'Tambah Dokumen', 'header' => 'Dokumen', 'subTitle' => 'Tambah Dokumen'])
            ...
            <div class="card-body">
                ...
                <form action="{{ route('dokumen.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="nama" placeholder="Nama Dokumen" name="nama_dokumen" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label" for="keterangan">Keterangan</label>
                        <div class="col-sm-10">
                            <textarea class="form-control" id="keterangan" rows="3" placeholder="Keterangan" name="keterangan"></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
